        ...
        <footer className="w-full border-t border-slate-200 bg-slate-50 py-12 text-sm leading-relaxed">
          <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-8 md:flex-row">
            ...
            <div className="flex gap-8">
              <a className="text-slate-500 transition-colors hover:text-[#f97316] hover:underline" href="/faq">
                Integritetspolicy
              </a>
              <a className="text-slate-500 transition-colors hover:text-[#f97316] hover:underline" href="/faq">
                Användarvillkor
              </a>
              <a className="text-slate-500 transition-colors hover:text-[#f97316] hover:underline" href="/kontakt">
                Kontakt
              </a>
            </div>
